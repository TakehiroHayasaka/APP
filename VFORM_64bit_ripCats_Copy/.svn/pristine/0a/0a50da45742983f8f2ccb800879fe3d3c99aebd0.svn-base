...
Public Class SunpoSetTable
    ...
    Private ReadOnly S_ExSunpoVal As String() = {"ExSunpoVal"}              '27 その他、計測値を加工した値
    ...
    '(20170911 Kiryu Add)計測値の加工値追加
    Private _ExSunpoVal As String = ""
    Public Property ExSunpoVal() As String
        Get
            Return _ExSunpoVal
        End Get
        Set(ByVal value As String)
    ...
    Private Sub p_set_ExSunpoVal(ByRef IDR As IDataReader)
        _ExSunpoVal = GetDataByIndexOfDataReader(FIELD_INDEX(33), IDR)
    End Sub
    ...
    Public Sub SetFieldIndex(ByRef IDR As IDataReader)
        ...
        iList.Add(GetIndexOfDataReader(S_ExSunpoVal, IDR))            '26  flgScale(20150105 Tezuka ADD)
    ...
    Public Sub SetFieldIndexForCellTable(ByRef IDR As IDataReader)
        ...
        iList.Add(GetIndexOfDataReader(S_ExSunpoVal, IDR))           '19  ExSunpoVal
    ...
    Public Sub CreateField()
        ...
        If _ExSunpoVal <> "" Then
            ReDim Preserve strFieldNames(IDX)
            ReDim Preserve strFieldTexts(IDX)
            strFieldNames(IDX) = "ExSunpoVal"
            strFieldTexts(IDX) = dblField(_ExSunpoVal)
            IDX += 1
        End If
    ...
    Public Sub SetUpdateField()
        ...
        ReDim strFieldNames(21)
        ReDim strFieldTexts(21)
        ...
        strFieldTexts(21) = dblField(_ExSunpoVal)
        ...
        Try
            ...
            Select Case SunpoCalcHouhou
                ...
                Case SunpoKeisanHouhou.Point
                    Select Case seibunXYZ
                        Case XYZseibun.X
                            SunpoVal = System.Math.Abs(GetPoint_CTID(CInt(CT_ID1)).X.D)
                        Case XYZseibun.Y
                            SunpoVal = System.Math.Abs(GetPoint_CTID(CInt(CT_ID1)).Y.D)
                        Case XYZseibun.Z
                            SunpoVal = System.Math.Abs(GetPoint_CTID(CInt(CT_ID1)).Z.D)
                        Case Else
                            Exit Function
                    End Select
