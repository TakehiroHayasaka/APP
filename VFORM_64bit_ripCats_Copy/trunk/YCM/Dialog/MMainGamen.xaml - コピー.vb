...
#End If
    ...
    Private Sub SystemSettingExport(sender As System.Object, e As System.Windows.RoutedEventArgs)
        ...
        Try
            ...
            ' strSql = "SELECT * FROM CT_CoordSetting WHERE TypeID = " & CommonTypeID & " ORDER BY ID"
            ...
            'Dim strSql As String = KIDX.SQLTEXT()
            ...
            'strSql = "SELECT * FROM " & "SunpoSet" & " WHERE TypeID = " & CommonTypeID & " ORDER BY SunpoID"
            ...
            'IDR = system_dbclass.DoSelect(strSql)
            'If Not IDR Is Nothing Then
    ...
    Private Sub SystemSettingInport(ByVal TypeID As Integer)
        ...
        'Dim strSql As String = "CT_Bunrui"
        'Dim strWhere As String = "TypeID =" & CommonTypeID.ToString

        'system_dbclass.DoDelete("CT_Bunrui", strWhere)
        'system_dbclass.DoDelete("CT_CoordSetting", strWhere)
        'system_dbclass.DoDelete("KihonInfo", strWhere)
        'system_dbclass.DoDelete("SunpoSet", strWhere)
        'system_dbclass.DoDelete("TenGunTeigi", strWhere)
    ...
    Private Sub SystemSettingDelete(ByRef dbClass As FBMlib.CDBOperateOLE, ByVal TypeID As Integer, ByVal DelTypeIDFlg As Boolean)
        ...
        dbClass.DoDelete("TenGunTeigi", strWhere)
