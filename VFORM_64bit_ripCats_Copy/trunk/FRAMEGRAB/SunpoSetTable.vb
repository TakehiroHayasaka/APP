...
#Region "データ取得"
    ...
    Public Function GetExcelTemplateFileName() As String
        GetExcelTemplateFileName = ""
        ...
        If Not IDR Is Nothing Then
            ...
            Do While IDR.Read
                GetExcelTemplateFileName = IDR.GetValue(2).ToString
            Loop
            IDR.Close()
        End If
