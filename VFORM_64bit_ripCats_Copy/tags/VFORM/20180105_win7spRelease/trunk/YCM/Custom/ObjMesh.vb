Public Class ObjToMeshConverter
    ...
    Private Sub ConvertFace()
        ...
        For i = 0 To _face.Count - 1
            ...
            Dim vertex = _loadResult.Vertices(faceVertex.VertexIndex - 1)
            _mesh.Triangles.Add(New ObjVec3(vertex.x, vertex.y, vertex.z))
        Next
    End Sub
...
Public Class ObjMesh
    ...
    Public Property Triangles As List(Of ObjVec3)

    Public Property Normals As List(Of ObjVec3)

    Public Sub New()
        Triangles = New List(Of ObjVec3)
