...
first_lbl:
    ...
    Public Sub Command_reconstruct()
        ...
        If reconstructfrm Is Nothing Then
            View_Dilaog.Model3dPath = Nothing
            reconstructfrm = New ReconstructionWindow
            Thread.Sleep(1000)
            reconstructfrm.ShowDialog()
            reconstructfrm = Nothing
    ...
    Public Sub Command_loadreconstruct()
        ...
        If My.Computer.FileSystem.FileExists(reconstructionModelPath) Then
            ...
            For Each objPoints As ObjVertex In modelPoints.Vertices
                objPoints.SetScale(ScaleToMM)
            Next
