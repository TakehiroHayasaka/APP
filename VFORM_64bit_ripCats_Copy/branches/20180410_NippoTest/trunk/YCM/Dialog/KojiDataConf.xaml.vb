...
#Region "サンプル作成"
    ...
    '        xlBookS.Close(False)
    '        System.Runtime.InteropServices.HOperatorSet.ClearObj(xlBookS)
    '        xlBookS = Nothing
    '        System.Runtime.InteropServices.HOperatorSet.ClearObj(xlSheet)
    '        xlSheet = Nothing
    '        xlExcel.DisplayAlerts = False
    '        xlExcel.Quit()
    '        System.Runtime.InteropServices.HOperatorSet.ClearObj(xlExcel)
    '        xlExcel = Nothing
    '        GC.Collect(2)
    '        ExKillProcess()
    '    End Try
