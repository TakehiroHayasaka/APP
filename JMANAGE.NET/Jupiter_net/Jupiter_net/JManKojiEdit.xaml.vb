...
Public Class JManKojiEdit
    ...
    Public Function OnInitialize(folder As String, buttonColor As Integer, backColor As Integer) As Integer
        ...
        If buttonColor = 0 Then
            Me.ButtonKojiEdit.Background = New SolidColorBrush(System.Windows.Media.Color.FromArgb(255, 50, 50, 50))
            Me.ButtonKojiEditCansel.Background = New SolidColorBrush(System.Windows.Media.Color.FromArgb(255, 50, 50, 50))
        Else
            Me.ButtonKojiEdit.Background = New SolidColorBrush(System.Windows.Media.Color.FromArgb(255, 0, 164, 150))
            Me.ButtonKojiEditCansel.Background = New SolidColorBrush(System.Windows.Media.Color.FromArgb(255, 0, 164, 150))
        End If
        ...
        If _kozoNo = -1 Then
            MessageBox.Show("工号、工事名、チャージコード、橋梁形式が取得できませんでした。工事フォルダを開いているか確認してください。", "JupiterManager", MessageBoxButtons.OK, MessageBoxIcon.Error)
            OnInitialize = 1
            Exit Function
        End If
    ...
    Private Sub OnClick_ButtonKojiEditCansel(sender As Object, e As RoutedEventArgs) Handles ButtonKojiEditCansel.Click
