...
Module JJmIni
	...
	Function FunGetAcad() As String
        ...
        Dim ans As New Compatibility.VB6.FixedLengthString(MAX_CHAR)
        Dim PathName As String
        Dim ret As Integer

        IniFile = FunGetEnviron(0) & "JMANAGE.INI"
...
NO_DRIVE:
    ...
    Function FunGetBin(flag As Integer) As String
        '---------------------------------------------------------------------------------------------------
        '機能
        ...
        PathName = FunGetGensun(flag) & "BIN\"
    ...
    Function FunGetEnviron(flag As Integer) As String
        '---------------------------------------------------------------------------------------------------
        '機能
        ...
        PathName = FunGetGensun(flag) & "ENVIRON\"
...
NO_DRIVE:
    ...
    Function FunGetGensun(flag As Integer) As String
        '---------------------------------------------------------------------------------------------------
        '機能
    ...
    Function FunGetKoji(flag As Integer) As String
        '---------------------------------------------------------------------------------------------------
        '機能
    ...
    Function FunGetNewKoji(flag As Integer) As String
        '---------------------------------------------------------------------------------------------------
        '機能
        ...
        If flag = 0 Then
            IniFile = FunGetEnviron(flag) & "JMANAGE.INI"
        Else
            IniFile = FunGetEnviron(flag) & "CMANAGE.INI"
        End If
    ...
    Function FunGetNewKoji2(flag As Integer) As String
        '---------------------------------------------------------------------------------------------------
        '機能
        '   JMANAGE.INIに設定されている[新規工事]のﾊﾟｽ名を取得する。
        '引数
    ...
    Sub subSetActiveData(ByRef Kogo As String, flag As Integer)
        '---------------------------------------------------------------------------------------------------
        '機能
    ...
    Function FunGetInputBin() As String
        ...
        PathName = FunGetGensun(0) & "JP_InputData\"
    ...
    Function FunGetTransLate(ByRef strAppName As String, ByRef strKeyName As String, ByRef strDefault As String) As String
        ...
        Dim ans As New Compatibility.VB6.FixedLengthString(256)
        Dim strFileName As String
        Dim ret As Integer

        strFileName = FunGetLanguage(0)
    ...
    Function FunJudgeJpnFlg() As Integer
        ...
        If Not strFileName Like "*JPN.INI" Then
            ...
            'UPGRADE_WARNING: Dir has a new behavior. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"'
            If Dir(FunGetEnviron(0) & "ENG.INI", FileAttribute.Normal) = "" Then
                FunJudgeJpnFlg = 0
            Else
                FunJudgeJpnFlg = 1
            End If
    ...
    Sub subJmIniSetSection(apName As String, keyName As String, param As String, flag As Integer)
        '---------------------------------------------------------------------------------------------------
        '機能
